...
import com.abaddon83.legal.domainModel.ddMandates.{Creditor, DE1, IT1, LegalEntityCode, UK1}
import com.abaddon83.legal.ports.CreditorPort

class FakeCreditorAdapter extends CreditorPort{
  override def findByLegalEntity(legalEntityCode: LegalEntityCode): Option[Creditor] = {
